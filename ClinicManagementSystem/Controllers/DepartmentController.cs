...
namespace ClinicManagementSystem.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        {
            var departments = await _unitOfWork.Departments.GetAll(); // جلب جميع الأقسام بشكل غير متزامن
        ...
        {
            var department = await _unitOfWork.Departments.GetById(id); // جلب القسم بناءً على المعرف
            if (department == null)
            {
                return NotFound();
            }
